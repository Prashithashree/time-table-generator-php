...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">KPRIET AUTOMATIC TIMETABLE GENERATOR</h3>
        </div>
    </div>
</div>
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/oat.jpg" alt="KPR">
        </div>

        <div class="item">
            <img src="assets/img/kpriet.png" alt="INY">
        </div>
        ...
        <div class="item">
            <img src="assets/img/libr.jpg" alt="INY">
        </div> 
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="8">  B.E(CSE) I A</option>
            <option value="8">  B.E(CSE) I B </option>
            <option value="8">  B.E(CSE) I C </option>
            <option value="3">  B.E(CSE) II A</option>
            <option value="4">  B.E(CSE) II B</option>
            <option value="4">  B.E(CSE) II C</option>
            <option value="5">  B.E(CSE) III A</option>
            <option value="6">  B.E(CSE) III B</option>
            <option value="6">  B.E(CSE) III C</option>
            <option value="8">  B.E(CSE) IV A</option>
            <option value="8">  B.E(CSE) IV B</option>
            <option value="8">  B.E(CSE) IV C</option>
        </select>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/kathir.png" class="img-rounded"/>
                    <h3 align="center">Prof.KATHIRESAN</h3>
                    <hr/>
                    <h4 align="center">Chief Mentor<br/>cse b</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/jeevi.jpg" class="img-rounded"/>
                    <h3 align="center">PROF.JEEVITHA R</h3>
                    <hr/>
                    <h4 align="center">Mentor<br/> cse b</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/mouthami.jpg" class="img-rounded"/>
                    <h3 align="center">PROF. MOUTHAMI</h3>
                    <hr/>
                    <h4 align="center">Mentor<br/> cse b</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <h2><strong>Prepared by</strong></h2>
            <hr/>
            <div>
                <h4>kamalavikashini CB
                </h4>
                <h4>pooja D</h4>
                <h4>prashitha shree A</h4>
