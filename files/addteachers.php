    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="addclassrooms.php">ADD CLASS</a></li>
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">ALLOTMENT
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href=allotpracticals.php>LAB</a>
                        </li>
                        <li>
                            <a href=allotclasses.php>CLASS</a>
                        </li>
                    </ul>
                </li>
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="alias_name" name="AL" placeholder="Alais...">
                    </div>
                    <div class="form-group">
